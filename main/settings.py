...
STORE_UPLOADED_MEDIA = env_bool("STORE_UPLOADED_MEDIA", False)
...
LOCAL_IMAGE_FAST_WORKING_SIZE = env_int("LOCAL_IMAGE_FAST_WORKING_SIZE", 192)
FAST_VIDEO_ANALYSIS_SECONDS = env_int("FAST_VIDEO_ANALYSIS_SECONDS", 6)
FAST_VIDEO_FRAMES = env_int("FAST_VIDEO_FRAMES", 2)
FAST_VIDEO_PREVIEW_WIDTH = env_int("FAST_VIDEO_PREVIEW_WIDTH", 640)
FAST_AUDIO_ANALYSIS_SECONDS = env_int("FAST_AUDIO_ANALYSIS_SECONDS", 4)
